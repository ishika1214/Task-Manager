    ...
    return (
      <div className="space-y-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">The user profile you're looking for doesn't exist.</p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{user.name}'s Profile</h1>
            <p className="text-gray-600 dark:text-gray-400">View team member profile and achievements</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-6">
              <Badge variant="outline" className="flex items-center space-x-2 px-3 py-1">
                ...
                ></div>
                {getStatusIcon()}
                <span>{statusOptions.find((s) => s.value === user.status)?.label}</span>
              </Badge>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <span className="text-sm text-gray-500">from {praise.givenBy}</span>
                        </div>
                        <p className="text-sm">{praise.reason}</p>
                        <p className="text-xs text-gray-500 mt-1">{new Date(praise.date).toLocaleDateString()}</p>
                      </div>
                    </div>
                  )
                })}
        ...
        <TabsContent value="stats" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-primary">{user.stats.projectsCompleted}</div>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-blue-600">{user.stats.teamCollaborations}</div>
                <p className="text-xs text-muted-foreground">Cross-team projects</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-yellow-600">{user.stats.avgRating}</div>
